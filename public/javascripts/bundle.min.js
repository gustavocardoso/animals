...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__modules_animals___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__modules_animals__);
...
var animals = __WEBPACK_IMPORTED_MODULE_1__modules_animals___default.a;
  ...
  _createClass(App, [{
    ...
    value: function setWord(animal) {
      ...
      this.playerWord.ontimeupdate = function () {
        if (_this4.playerWord.currentTime > timeEnd) {
          _this4.playerWord.pause();
        }
      };
    }
  }, {
    ...
    value: function setSound(animal) {
      ...
      audioFormats.forEach(function (element, index) {
        ...
        _this5.playerSound.appendChild(soundElement);

        _this5.playerSound.load();
      });
    }
  }]);
